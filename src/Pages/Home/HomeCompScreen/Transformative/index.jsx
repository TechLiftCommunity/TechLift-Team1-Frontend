...
const Transformative = () => {
  ...
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 max-h-screen space-x-36 place-items-center bg-fcWhite px-16 mt-16 ">
          ...
          {data1.map((item, index) => {
            return (
              <div key={index} className="">
                <div>
                  <p className="text-fcBlack text-[40px] xl:leading-[45px]  font-semibold">
