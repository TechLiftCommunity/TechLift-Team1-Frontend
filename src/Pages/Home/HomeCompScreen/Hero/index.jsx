...
const Hero = () => {
  return (
    // <div className="grid lg:grid-cols-2 grid-cols-1 lg:max-h-screen space-y-8 lg:space-y-0 text-center lg:text-start  place-items-center bg-fcWhite px-6 lg:px-14 mt-32">
    //   <div className="space-y-8 lg:space-y-6 lg:px-0 px-4 ">
    ...
    //     </p>
    //     <p className="font-SpaceGrotesk text-center   text-[16px]  lg:text-start lg:text-[19px] text-black2 ">
    ...
    //       <SecondaryButton className="text-fcWhite rounded-lg w-40  text-[14px] sm:text-base lg:text-xl px-4 py-2 font-SpaceGrotesk font-medium  border border-fcPrimary bg-fcPrimary">
    //         Join Community
    //       </SecondaryButton>
    //       <SecondaryButton className="text-fcPrimary rounded-lg w-40 text-[14px] sm:text-base lg:text-xl text-base px-4 py-2 font-SpaceGrotesk font-medium  border border-fcPrimary bg-white">
    //         Learn more
    //       </SecondaryButton>
    //     </div>
    //   </div>
    //   <div className="lg:w-full sm:w-full w-full items-center mr-6 lg:mr-0  ml-0 lg:ml-0 my-4 lg:mt-4 flex justify-center ">
